...
(function () {
  ...
  var hero = (function () {
    ...
    // Pause the carousel while it is being inspected, then resume automatically.
    ...
    root.addEventListener('focusin', function () { clearInterval(timer); root.classList.add('paused'); });
    root.addEventListener('focusout', function () { if (!root.contains(document.activeElement)) { root.classList.remove('paused'); restart(); } });
